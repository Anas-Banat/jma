          ...
          <div className="relative md:-mx-4 flex flex-grow-0 items-center justify-between">
            <div className="w-60 flex-none">
              <div className='flex grow items-center my-4 '>
                <Logo/>
                <div className={`flex-nowrap flex-col w-3/4 
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                ...
                <nav
                  id="navbarCollapse"
                  className={`navbar absolute right-0 z-30 w-[250px] rounded-lg border-[.5px] border-body-color/50 bg-white px-6 py-4 duration-300 dark:border-body-color/20 dark:bg-dark-2 lg:visible lg:static lg:w-auto lg:border-none lg:!bg-transparent lg:p-0 lg:opacity-100 lg:dark:bg-transparent ${
                    navbarOpen
