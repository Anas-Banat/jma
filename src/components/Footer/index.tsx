...
import logo from "../../../public/images/logo/jma_white_logo.png";
...
const footerLink = (href: string, text: string ) => {
  return (
    <Link href={href} className="mb-3 inline-block text-base text-gray-7 hover:text-primary">
      {text}
    </Link>
  );    
};
...
const Footer = () => {
  ...
  return (
    <footer dir={language === "ar" ? "rtl" : "ltr"}
      className="wow fadeInUp relative z-10 bg-[#090E34] md:pt-10 "
      data-wow-delay=".15s"
    >
      <div className="hidden md:block container">
        <div className="flex flex-wrap md:place-content-between">
          <div className="flex w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              <Link href="/" className="mb-6 inline-block max-w-[160px]">
                <Image
                  src={logo}
                  alt= {language === "ar" ? "نقابة الأطباء الأردنية" : "Jordan Medical Association"}
                  width={140}
                  height={30}
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            <div className="mb-10 w-full">
              ...
              <ul>
                <li>
                  {footerLink("/about", language === "ar" ? "عن النقابة" : "About Us")}
                </li>
                <li>
                {footerLink("/events", language === "ar" ? "المؤتمرات" : "Conferences")}
                </li>
                <li>
                {footerLink("pages/news", language === "ar" ? "الأخبار" :"News")}
                </li>
                <li>
                {footerLink("/faq", language === "ar" ? "الأسئلة الأكثر تكرارا" : "FAQs")}
                </li>
              </ul>
            </div>
          </div>
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            <div className="mb-10 w-full">
              ...
              <ul>
                <li>
                  {footerLink("/authority_fund", language === "ar" ? "صندوق التقاعد" : "Authority Fund")}
                </li>
                <li>
                  {footerLink("/social_solidarity_fund", language === "ar" ? "صندوق التكافل الاجتماعي" : "Social Solidarity Fund")}
                </li>
                <li>
                  {footerLink("/mobile_phone_fund", language === "ar" ? "صندوق الهاتف المحمول" : "Mobile phones Fund")}
                </li>
                <li>
                  {footerLink("/doctors_collaboration_fund", language === "ar" ? "الصندوق التعاوني للأطباء" : "Doctors Collaboration Fund")}
                </li>
                <li>
                  {footerLink("/health_insurance_fund", language === "ar" ? "صندوق التامين الصحي الأختياري" : "Optional Health Insurance Fund")}
                </li>
              </ul>
            </div>
          </div>
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            <div className="mb-10 w-full">
              ...
              <ul>
                <li>
                {footerLink("https://maps.app.goo.gl/kEoA1PrZZXvVstKDA", language === "ar" ? "الشميساني، عمان" :  "Al Shmaisani, Amman")}
                </li>
                <li>
                {footerLink("mailto:info@jma.com", language === "ar" ? "البريد الإلكتروني: info@jma.org.jo" :  "Email: info@jma.org.jo")}
                </li>
                <li>
                {footerLink("tel:+96265665620", language === "ar" ? "التليفون: 0096265665620" :  "Tel: 0096265665620")}
                </li>
                <li>
                {footerLink("/", language === "ar" ? "الفاكس: 5686435" :  "Fax: 5686435")}
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="-mx-4 flex flex-wrap">
            ...
            <div className="w-full px-4 md:w-1/3 lg:w-1/2">
              <div className="my-1 flex justify-center md:justify-end">
                <p className="md:text-lg text-xs text-gray-7 ">
                  {language === "ar" ? "© حقوق النشر 2024. جميع الحقوق محفوظة لنقابة الأطباء الأردنية." : "© Copyright 2024. All Rights Reserved by JMA."}
                  {" "}
                  <Link
                    href="/"
                    className="text-base text-white md:hover:text-primary md:hover:underline md:hover:text-lg md:hover:font-bold"
                  >
                   </Link>
                </p>
              </div>
      ...
      <div className='hidden md:block '>
        <span className="absolute left-0 top-0 z-[-1] aspect-[95/50] w-full max-w-[570px]">
