...
const Footer = () => {
  return (
    <footer
      className="wow fadeInUp relative z-10 bg-[#090E34] md:pt-20 lg:pt-[100px]"
      data-wow-delay=".15s"
    >
        ...
        <div className="flex flex-wrap md:place-content-between">
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            <div className="mb-10 w-full">
              ...
              <ul>
                <li>
                  {footerLink("/authority_fund", "Authority Fund")}
                </li>
                <li>
                  {footerLink("/social_solidarity_fund", "Social Solidarity Fund")}
                </li>
                <li>
                  {footerLink("/mobile_phone_fund", "Mobile phones Fund")}
                </li>
                <li>
                  {footerLink("/doctors_collaboration_fund", "Doctors Collaboration Fund")}
                </li>
              </ul>
            </div>
          </div>
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            <div className="mb-10 w-full">
              ...
              <ul>
                <li>
                {footerLink("https://maps.app.goo.gl/kEoA1PrZZXvVstKDA", "Al Shmaisani, Amman")}
                </li>
                <li>
                {footerLink("mailto:info@jma.com", "Email: info@jma.com")}
                </li>
                <li>
                {footerLink("tel:+96265665620", "Tel: +962 6566 5620")}
                </li>
                <li>
                {footerLink("/", "Fax: 5686435")}
                </li>
              </ul>
            </div>
          </div>
      ...
      <div className="border-t border-[#8890A4] border-opacity-40 py-8 lg:mt-[60px]">
