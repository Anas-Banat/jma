        ...
        <div className="-mx-4 flex flex-wrap ">
            ...
            <div className="ud-contact-content-wrapper">
              ...
              <div className="mb-12 flex flex-wrap justify-between lg:mb-0">
                <div className="mb-8 flex w-[330px] max-w-full">
                  ...
                  <div>
                    <h3 className="px-2 mb-[18px] text-lg font-semibold text-dark dark:text-white">
                      {language === "ar" ? " موقعنا " : " Our Location "}
                    </h3>
                    <p className="text-base text-body-color dark:text-dark-6">
                      {language === "ar" ? "مجمع النقابات، الشميساني، عمان" : "Associations Complex, Al Shmaisani, Amman"}
                    </p>
                  </div>
                </div>
                <div className="mb-8 flex w-[330px] max-w-full">
                  ...
                  <div>
                    ...
                    <p className="text-base text-body-color dark:text-dark-6">
                      info@jma.org.jo <br/> 0096265665620
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="w-full lg:w-5/12 xl:w-4/12">
            <div
              ...
              "
            >
              <h3 dir={language === "ar" ? "rtl" : "ltr"} className="mb-8 text-2xl font-semibold text-dark dark:text-white md:text-[28px] md:leading-[1.42]">
              {language === "ar" ? " ارسل لنا رسالة " : " Send us a Message "}
              </h3>
              <form dir={language === "ar" ? "rtl" : "ltr"}>
                ...
                <div className="mb-[22px]">
                  <label
                    ...
                    className="mb-4 block text-sm text-body-color dark:text-dark-6"
                  >
                    {language === "ar"? " *رقم التلفون " : " Phone* "}
                  </label>
                  <input
                    type="text"
                    name="phone"
                    placeholder="00962771234567"
                    className="w-full border-0 border-b border-[#f1f1f1] bg-transparent pb-3 text-dark placeholder:text-body-color/60 focus:border-primary focus:outline-none dark:border-dark-3 dark:text-white"
                  />
                </div>
